...
function(input, output, session) {
    ...
    
  {
    ...
    df_training <- fread(sprintf("data/BVTappRegression/d%s_n%s_e%s/df_training_full.csv", dataset_id, size_id, noise_id))
    df_training_ys <- fread(sprintf("data/BVTappRegression/d%s_n%s_e%s/df_training_ys.csv", dataset_id, size_id, noise_id))
    df_test <- fread(sprintf("data/BVTappRegression/d%s_n%s_e%s/df_test.csv", dataset_id, size_id, noise_id))
    results_polynomial <- fread(sprintf("data/BVTappRegression/d%s_n%s_e%s/results_polynomial.csv", dataset_id, size_id, noise_id))
    results_spline <- fread(sprintf("data/BVTappRegression/d%s_n%s_e%s/results_spline.csv", dataset_id, size_id, noise_id))
    results_knn_reg <- fread(sprintf("data/BVTappRegression/d%s_n%s_e%s/results_knn_reg.csv", dataset_id, size_id, noise_id))
    results_tree_reg <- fread(sprintf("data/BVTappRegression/d%s_n%s_e%s/results_tree_reg.csv", dataset_id, size_id, noise_id))
    results_lasso <- fread(sprintf("data/BVTappRegression/d%s_n%s_e%s/results_lasso.csv", dataset_id, size_id, noise_id))
    # df3_list_polynomial <- fread(sprintf("data/BVTappRegression/d%s_n%s_e%s/df3_list_polynomial.csv", dataset_id, size_id, noise_id))
    df3_list_polynomial <- read_parquet(sprintf("data/BVTappRegression/d%s_n%s_e%s/df3_list_polynomial.parquet", dataset_id, size_id, noise_id))
    df3_list_spline <- read_parquet(sprintf("data/BVTappRegression/d%s_n%s_e%s/df3_list_spline.parquet", dataset_id, size_id, noise_id))
    df3_list_knn_reg <- read_parquet(sprintf("data/BVTappRegression/d%s_n%s_e%s/df3_list_knn_reg.parquet", dataset_id, size_id, noise_id))
    df3_list_tree_reg <- read_parquet(sprintf("data/BVTappRegression/d%s_n%s_e%s/df3_list_tree_reg.parquet", dataset_id, size_id, noise_id))
    df3_list_lasso <- read_parquet(sprintf("data/BVTappRegression/d%s_n%s_e%s/df3_list_lasso.parquet", dataset_id, size_id, noise_id))
